...
import pandas as pd
                                        ...
                                        ## To Add External CSS ##
with open('C:/Users/ASUS/Downloads/medicine-recommendation-system-main/medicine-recommendation-system-main/css/style.css') as f:
...
medicines_dict = pickle.load(open('C:/Users/ASUS/Downloads/medicine-recommendation-system-main/medicine-recommendation-system-main/medicine_dict.pkl','rb'))
medicines = pd.DataFrame(medicines_dict)

                    # To load similarity-vector-data from pickle in the form of dictionary
similarity = pickle.load(open('C:/Users/ASUS/Downloads/medicine-recommendation-system-main/medicine-recommendation-system-main/similarity.pkl','rb'))
...
image = Image.open('C:/Users/ASUS/Downloads/medicine-recommendation-system-main/medicine-recommendation-system-main/images/medicine-image.jpg')
